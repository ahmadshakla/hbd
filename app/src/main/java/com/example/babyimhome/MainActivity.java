...
public class MainActivity extends AppCompatActivity {
    ...
    BroadcastReceiver localSendSmsBroadcastReceiver;
    SMSPopup smsPopup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(localSendSmsBroadcastReceiver, new IntentFilter(ACTION));
        currLocation = null;
    ...
    private void handleStartButton(final Button button) {
